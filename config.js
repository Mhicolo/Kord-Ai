...
module.exports = { 
    ...
    OWNER_NUMBER: process.env.OWNER_NUMBER || "2348035936169",
    ...
    STICKER_PACKNAME: process.env.STICKER_PACKNAME || "Mhicolo",
    STICKER_AUTHOR: process.env.STICKER_AUTHOR || "🤍",
    BOT_PRESENCE: process.env.BOT_PRESENCE || "available",
    REACT: process.env.REACT || false,
    READ_MESSAGE: process.env.READ_MESSAGE || "false",
    OWNER_NAME: process.env.OWNER_NAME || "Ifeoluwa",
    BOT_NAME: process.env.BOT_NAME || "Mhicolo",
